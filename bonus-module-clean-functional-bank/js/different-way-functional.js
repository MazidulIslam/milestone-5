...
function updateBalance() {
    ...
    const depositTotal = getInnerTextValue('deposit-dashboard');
    const withdrawTotal = getInnerTextValue('withdraw-dashboard');
    // const balanceTotal = getInnerTextValue('balance-total');
    const newBalance = depositTotal - withdrawTotal + 1240;
